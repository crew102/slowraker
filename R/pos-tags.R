...
#' \code{\link{openNLP}} package. This list was taken from \href{http://martinschweinberger.de/docs/articles/PosTagR.pdf}{Part-Of-Speech Tagging with R}. \code{pos_tags}
